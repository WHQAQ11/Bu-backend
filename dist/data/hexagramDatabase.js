...
exports.getHexagramByTrigrams = exports.getHexagramByName = exports.getHexagramByNumber = exports.COMPLETE_HEXAGRAMS = void 0;
exports.detectQuestionType = detectQuestionType;
exports.getQuestionTypeName = getQuestionTypeName;
exports.COMPLETE_HEXAGRAMS = [
    {
        number: 1,
        name: '乾',
        upper: 'qian',
...
const getHexagramByNumber = (number) => {
    return exports.COMPLETE_HEXAGRAMS.find(hexagram => hexagram.number === number);
};
exports.getHexagramByNumber = getHexagramByNumber;
const getHexagramByName = (name) => {
    return exports.COMPLETE_HEXAGRAMS.find(hexagram => hexagram.name === name);
};
exports.getHexagramByName = getHexagramByName;
const getHexagramByTrigrams = (upper, lower) => {
    return exports.COMPLETE_HEXAGRAMS.find(hexagram => hexagram.upper === upper && hexagram.lower === lower);
};
exports.getHexagramByTrigrams = getHexagramByTrigrams;
...
//# sourceMappingURL=hexagramDatabase.js.map