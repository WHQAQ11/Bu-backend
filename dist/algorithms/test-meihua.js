...
const meihua_1 = require("./meihua");
console.log('=== 测试梅花易数算法 ===\n');
console.log('1. 随机数字起卦测试:');
const randomResult = (0, meihua_1.performMeihuaDivination)('我的感情运势如何？');
...
const numberResult = (0, meihua_1.meihuaNumberDivination)([3, 7, 5]);
...
const timeResult = (0, meihua_1.meihuaTimeDivination)(2024, 10, 12, 17);
...
const wordResult = (0, meihua_1.meihuaWordDivination)('梅花易数');
...
const singleWordResult = (0, meihua_1.meihuaWordDivination)('福');
...
//# sourceMappingURL=test-meihua.js.map